...
\date{}
\usepackage[top=1.5 in,bottom=1.5 in]{geometry}
\usepackage{color}
\usepackage{xcolor}
\usepackage{graphics}
...
\chapter{Introduction to Public Key Cryptography}
...
\begin{itemize}
    ...
    \item \textbf{Digest Algorithms}~\cite{eric}
        ...
        \end{itemize}
\end{itemize}
\section{Mathematics behind cryptography}
        ...
        \item \textbf{Handshake Protocol}
            \begin{itemize}
                ...
                \item The server sends a MAC of all the handshake messages to the client
                	 \begin{figure}[ht!]
                        \centering
                        \includegraphics[width=40mm]{Images/sslhandshake1.png}
                ...
                \item To protect the handshake from tampering, the content of the message is MAC of 
                    all the previous handshake messages
                	 \begin{figure}[ht!]
                        \centering
                        \includegraphics[height=40 mm, width=40 mm]{Images/sslhandshake2.png}
                        \caption{SSL Handshake}
                      \end{figure}
        ...
        \item \textbf{SSL Record Protcol}
            \begin{itemize}
                ...
                \item \begin{figure}[ht!]
                        \centering
                        \includegraphics[width=50mm]{Images/ssldatafrag.png}
...
\chapter{Introduction to Public Key Infrastructure}
...
\end{figure}
\section{Common Terms used in PKI}
\begin{itemize}
...
\end{itemize}
\section{Detailed look on certificate/CRL}
    \subsubsection {Certificates}
        \begin{itemize}
            ...
            \item Types of Certificate Authorities
                ...
                \end{itemize}
        \end{itemize}
    \subsection{Basic Certificate Fields}
        \begin{itemize}
            \item Version:
                \begin{itemize}
            ...
            \item Issuer:
                \begin{itemize}
                    ...
                    \begin{itemize}
                        ...
                        \item \textbf{C=DE, ST=Bayern, L=Muenchen, O=Whatever it is,}\\\textbf{CN=IO::Socket::SSL Demo CA}
                        \item \textbf{C=US, O=VeriSign, Inc., OU=Class 1 Public Primary Certification Authority}
                    \end{itemize}
                \end{itemize}
            \item Validity:
    ...
    \subsection{Extensions}
        \begin{itemize}
            ...
            \item Each Extension includes OID and ASN.1 DER  (OCTET)
                \begin{itemize}
                    \item Example:\\ \textbf{DE:65:01:16:19:2E:51:E0:9A:51:1A:37:50:94:7D:39:29:2A:42:2C}
                \end{itemize}
        ...
        \begin{itemize}
            \item \textbf{Authority Key Identifier:}
                \begin{itemize}
                    ...
                    \item Values:
                        \begin{itemize}
                            \item \textbf{keyid:} \\ \textbf{48:E6:68:F9:2B:D2:B2:95:D7:47:D8:23:20:10:4F:33:98:90:9F:D4}
                        \end{itemize}
                \end{itemize}
                    ...
                    \begin{itemize}
                        ...
                        \item Important Note:
                            \begin{itemize}
                                \item \begin{figure}[ht!]
                                    \centering
                                    \includegraphics[width=70mm]{Images/KeyUsage1.png}
                    ...
                    \item Example:
                        \begin{itemize}
                            \item Authority Key Identifier Example:
                                ...
                                \begin{figure}[ht!]
                                    \centering
                                    \includegraphics[width=65mm]{Images/crl-aki.png}
                ...
                \begin{itemize}
                    ...
                    \item Example:
                        \begin{itemize}
                            \item \begin{figure}[ht!]
                                    \centering
                                    \includegraphics[width=80mm]{Images/delta-crl-extension.png}
                ...
                \begin{itemize}
                    ...
                    \item Example:
                        \begin{itemize}
                            \item \begin{figure}[ht!]
                                    \centering
                                    \includegraphics[width=80mm]{Images/issuing-distribution-point.png}
...
$ openssl pkcs12 -nocerts -in pki1.pk12 -out pki1.key.pem -nodes
        ...
        \end{itemize}
\end{enumerate}
\chapter{Common Terms Used in RHCS}
\begin{itemize}
    \item Enrollment
...
\end{itemize}
\chapter{Red Hat Certificate System}
    \begin{itemize}
        ...
        \item Enrollment:
            ...
            \begin{itemize}
                ...
                \item The new certificate is stored in Certificate Managers internal database.
                    \begin{figure}[ht!]
                    \centering
                    \includegraphics[width=35mm]{Images/enrollment.png}
...
baseurl=http://download.eng.bos.redhat.com/rcm-guest/puddles/RHCS/
9.0.1/latest/x86_64/os/
enabled=1   
gpgcheck=0
...
baseurl=http://download.eng.pnq.redhat.com/released/RHEL-7/7.2/
Server-optional/x86_64/os/
enabled=1
gpgcheck=0
            \end{lstlisting}
...
$ pki -d /opt/rhqa_pki -c `Secret123' \
    ...
    cert-show 0xc
        ...
        \end{enumerate}
    \end{enumerate}
\section{Key Recovery Authority}
\subsection{Introduction}
...
\begin{itemize}
    \item Key Archival
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[width=100mm]{Images/key-archival1.png}
...
\end{figure}
\subsection{Common Terms Used with regard to Smartcard}
    \begin{itemize}
...
\subsection{Token Key Service}
    \begin{itemize}
        ...
        \item Features:
            ...
            \end{itemize}
    \end{itemize}
\subsection{Token Processing Service}
    \begin{itemize}
            \item Introduction
                \begin{itemize}
                ...
                \begin{itemize}
                    \item Secure Channel
                        \begin{itemize}
                            ...
                            \begin{figure}[H]
                                \centering
                                \includegraphics[width=80mm]{Images/tks-key-derivation1.png}
                    ...
                    \item TPS-TKS-Smartcard Workflow
                        \begin{figure}[H]
                            \centering
                            \includegraphics[width=120mm]{Images/tks-tps-drm-esc-enrollment2.png}
                    ...
                    \item TKS Configuration 
                        \begin{itemize}
                            ...
                            \begin{figure}[H]
                                \centering
                                \includegraphics[width=80mm]{Images/pkispawn-tks.png}
                    ...
                    \item Creating sharedSecret 
                        \begin{itemize}
                            ...
                            \begin{figure}[H]
                                \centering
                                \includegraphics[width=50mm]{Images/tkstool-create-sharedSecret1.png}
                    ...
                    \item TPS Configuration
                        \begin{itemize}
                            \item RPM: \textbf{pki-tps}
                                ...
                                \begin{figure}[H]
                                    \centering
                                    \includegraphics[width=80mm]{Images/pkispawn-tps.png}
                                    \caption{Interactive installation of TKS using pkispawn}
                                \end{figure}
                                \begin{figure}[H]
                                    \centering
                                    \includegraphics[width=80mm]{Images/pkispawn-tps2.png}
                            ...
                            \item Import SharedSecret
                                ...
                                \begin{figure}[H]
                                    \centering
                                    \includegraphics[width=80mm]{Images/tkstool-import-sharedSecret1.png}
                                    \caption{Get NSS Password of TPS NSS database}
                                \end{figure}
                                \begin{figure}[H]
                                    \centering
                                    \includegraphics[width=80mm]{Images/tkstool-import-sharedSecret2.png}
