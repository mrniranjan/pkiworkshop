...
$ pkiconsole https://pki1.example.org:8443/ca                    
                ...
                \item Click on Add:
                    ...
                    \end{itemize}
                \item Using EE request 5 certs and approve them using Agent
                \item From Agent interface revoke the 5 certs
                \item Update Certificate Revocation List from CA Agent interface
